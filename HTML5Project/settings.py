...
SECRET_KEY = 'django-insecure-jc1(ak^m3mw8wu!9u@ab=en6g!+&82=jwlvw(bd=43s+3_xvyp'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'AnimeDatabase',  # 连接的数据库
        'HOST': '127.0.0.1',  # mysql的ip地址
        'PORT': 3306,  # mysql的端口
        'USER': 'root',  # mysql的用户名
        'PASSWORD': 'Zust2022'  # mysql的密码
    }
}
...
STATIC_ROOT = os.path.join(BASE_DIR, '/template/static/') # 文件存放路径，根据实际情况修改
